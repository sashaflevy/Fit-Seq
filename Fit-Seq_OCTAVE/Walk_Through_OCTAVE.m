...
% Execute
[ TestSimplified_csv ] = evolution_0mut_simplified_OCTAVE(lineage, t_evo, cell_num_ini, x_ini, noise_option);
...
% Execute
[ TestComplex_csv ] = evolution_0mut_complex_OCTAVE(lineage, t_evo, cell_num_ini, x_ini, deltat, read_depth_average, noise_option);
...
%%
% Execute
[x_estimate_result, r_estimate_result, x_mean_estimate_result] =  ...
    FitSeq_OCTAVE(BC_num_mat_original, t_seq_vec, cell_depth, file_name);
