function [ file_name ] = evolution_0mut_complex_OCTAVE(lineage, t_evo, ...
...
if numvarargs > 6
    error('evolution_0mut_complex:TooManyInputs', 'requires at most 3 optional inputs');
end

vararg_update = {'format','csv', 'gDNA_copy',500, 'PCR_cycle',25};
