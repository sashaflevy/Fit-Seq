...
% -------------------------------------------------------------------------
% xini_opt_m2_complex
% A SUB-FUNCTION CALLED BY xini_opt_command.m TO CALCULATE THE OPPOSITE VALUE (-y) 
% OF THE LIKELIHOOD FUNCTION FOR A GENOTYPE GIVEN THE FITNESS OF THE GENOTYPE
%
%
% INPUTS
